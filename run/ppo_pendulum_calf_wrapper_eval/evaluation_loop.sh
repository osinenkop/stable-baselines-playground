...
do
    ...
    python pendulum_ppo_load_only.py --notrain --loadstep 500000 --seed $i --console --log

    # Eval checkpoint at step 200k of pure PPO + CALF wrapper
    python pendulum_ppo_load_only.py --notrain --loadstep 200000 --seed $i --console --log
