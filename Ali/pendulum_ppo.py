...
if not args.notrain:
    ...
    model.learn(total_timesteps=total_timesteps, tb_log_name="PPO_CaLF")
    # Save the model after training
    model.save("ppo_pendulum_calf")
...
model = PPO.load("ppo_pendulum_calf_1")
