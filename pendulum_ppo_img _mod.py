...
gym.envs.registration.register(
    ...
    entry_point="mygym_img.my_pendulum:PendulumRenderFix",
)
...
ppo_hyperparams = {
    "learning_rate": 1e-2,#5e-4,  # The step size used to update the policy network. Lower values can make learning more stable.
...
model = PPO.load("ppo_pendulum_modi")
